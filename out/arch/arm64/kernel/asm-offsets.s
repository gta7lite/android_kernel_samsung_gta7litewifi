...
.Lmain$local:
.Lfunc_begin0:
	.file	1 "/home/zillion/Desktop/wip/android_kernel_samsung_gta7litewifi/out/../arch/arm64/kernel/asm-offsets.c"
	.loc	1 40 0                  // ../arch/arm64/kernel/asm-offsets.c:40:0
...
// %bb.0:
	...
	.cfi_offset w29, -16
.Ltmp0:
	.loc	1 40 0 prologue_end     // ../arch/arm64/kernel/asm-offsets.c:40:0
	bl	_mcount
.Ltmp1:
...
.ascii "->TSK_TI_PREEMPT 24 offsetof(struct task_struct, thread_info.preempt_count)"
	//NO_APP
	.loc	1 45 3                  // ../arch/arm64/kernel/asm-offsets.c:45:3
	//APP
	
.ascii "->TSK_TI_ADDR_LIMIT 8 offsetof(struct task_struct, thread_info.addr_limit)"
	//NO_APP
	.loc	1 47 3                  // ../arch/arm64/kernel/asm-offsets.c:47:3
	//APP
...
.ascii "->TSPEC_TV_SEC 0 offsetof(struct timespec, tv_sec)"
	//NO_APP
	.loc	1 143 3                 // ../arch/arm64/kernel/asm-offsets.c:143:3
	//APP
...
.ascii "->"
	//NO_APP
	.loc	1 145 3                 // ../arch/arm64/kernel/asm-offsets.c:145:3
	//APP
...
.ascii "->TZ_DSTTIME 4 offsetof(struct timezone, tz_dsttime)"
	//NO_APP
	.loc	1 147 3                 // ../arch/arm64/kernel/asm-offsets.c:147:3
	//APP
...
.ascii "->CPU_CTX_SP 104 offsetof(struct cpu_suspend_ctx, sp)"
	//NO_APP
	.loc	1 165 3                 // ../arch/arm64/kernel/asm-offsets.c:165:3
	//APP
...
.ascii "->MPIDR_HASH_SHIFTS 8 offsetof(struct mpidr_hash, shift_aff)"
	//NO_APP
	.loc	1 167 3                 // ../arch/arm64/kernel/asm-offsets.c:167:3
	//APP
...
.ascii "->SLEEP_STACK_DATA_CALLEE_REGS 112 offsetof(struct sleep_stack_data, callee_saved_regs)"
	//NO_APP
	.loc	1 170 3                 // ../arch/arm64/kernel/asm-offsets.c:170:3
	//APP
	
.ascii "->ARM_SMCCC_RES_X0_OFFS 0 offsetof(struct arm_smccc_res, a0)"
	//NO_APP
	.loc	1 171 3                 // ../arch/arm64/kernel/asm-offsets.c:171:3
	//APP
	
.ascii "->ARM_SMCCC_RES_X2_OFFS 16 offsetof(struct arm_smccc_res, a2)"
	//NO_APP
	.loc	1 172 3                 // ../arch/arm64/kernel/asm-offsets.c:172:3
	//APP
	
.ascii "->ARM_SMCCC_QUIRK_ID_OFFS 0 offsetof(struct arm_smccc_quirk, id)"
	//NO_APP
	.loc	1 173 3                 // ../arch/arm64/kernel/asm-offsets.c:173:3
	//APP
	
.ascii "->ARM_SMCCC_QUIRK_STATE_OFFS 8 offsetof(struct arm_smccc_quirk, state)"
	//NO_APP
	.loc	1 174 3                 // ../arch/arm64/kernel/asm-offsets.c:174:3
	//APP
	
.ascii "->"
	//NO_APP
	.loc	1 175 3                 // ../arch/arm64/kernel/asm-offsets.c:175:3
	//APP
	
.ascii "->HIBERN_PBE_ORIG 8 offsetof(struct pbe, orig_address)"
	//NO_APP
	.loc	1 176 3                 // ../arch/arm64/kernel/asm-offsets.c:176:3
	//APP
	
.ascii "->HIBERN_PBE_ADDR 0 offsetof(struct pbe, address)"
	//NO_APP
	.loc	1 177 3                 // ../arch/arm64/kernel/asm-offsets.c:177:3
	//APP
	
.ascii "->HIBERN_PBE_NEXT 16 offsetof(struct pbe, next)"
	//NO_APP
	.loc	1 178 3                 // ../arch/arm64/kernel/asm-offsets.c:178:3
	//APP
	
.ascii "->ARM64_FTR_SYSVAL 24 offsetof(struct arm64_ftr_reg, sys_val)"
	//NO_APP
	.loc	1 179 3                 // ../arch/arm64/kernel/asm-offsets.c:179:3
	//APP
	
.ascii "->"
	//NO_APP
	.loc	1 181 3                 // ../arch/arm64/kernel/asm-offsets.c:181:3
	//APP
	
.ascii "->TRAMP_VALIAS -279198060544 TRAMP_VALIAS"
	//NO_APP
	.loc	1 187 3                 // ../arch/arm64/kernel/asm-offsets.c:187:3
	mov	w0, wzr
...
.Linfo_string2:
	.asciz	"/home/zillion/Desktop/wip/android_kernel_samsung_gta7litewifi/out" // string offset=190
.Linfo_string3:
	.asciz	"main"                  // string offset=256
.Linfo_string4:
